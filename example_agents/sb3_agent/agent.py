...
class SB3PPOAgent:
    ...
    def __init__(self):
        super().__init__()
        self.sb3_ppo = self.AgentRun.get_last_logged_model("ppo.zip")
    ...
    def evaluate(
        ...
        with self.AgentRun(run_type='evaluate') as eval_run:
            evaluate_policy(
                model=self.sb3_ppo,
    ...
    def learn(self, total_timesteps=250):
        with self.AgentRun(run_type="learn") as learn_run:
            self.sb3_ppo.learn(
